/* ================================================================
 * C++ 学习工作台 · 扩展课程数据（由主页面 index.html 引入）
...
{id:"career",icon:"💼",name:"面试冲刺与就业准备",desc:"高频考点、简历、刷题路线、方向选择",
 ...
 {id:"cj3",title:"刷题路线与平台",min:10,summary:["路线：先按专题刷（链表→栈队列→哈希→树→图→DP），每专题 15~30 题，比乱刷效率高。","平台：LeetCode 中国（热题 HOT100）+ 牛客（公司真题/八股）；代码随想录有免费专题路线。","质量>数量：每题先独立想 20 分钟，看题解后必须重写，并按 3 天/7 天间隔重做。"],code:`// 刷题节奏（和本工作台的间隔复习同思路）\n// 第 1 遍：独立思考 20min → 卡住看题解 → 重写\n// 第 3 天 / 第 7 天：重做巩固`,pit:"只看不写等于白刷；追求题量不总结模板，忘得比刷得快——同类型题要归纳「套路卡」。",ex:{q:"半年刷多少题够面试？",a:"按专题精刷 150~250 题（含重做）足以覆盖大多数 C++ 后端/开发岗笔试。"},target:"制定按专题的刷题计划并开始执行。"},
...
const AGI_STAGES=[
  ...
  },
  {
    ...
    "lab": {
      ...
      "hint": "结合本工作台：C++ 底层 + Python/数学 + ML/DL + 前沿，每阶段都「做出一个能跑的东西」比看懂更重要。",
      "xp": 25
    },
    "lessons": [
      {
      ...
      },
      {
        ...
        "ex": {
          ...
          "a": "先走完本工作台：C++ 底层打底 + Python/数学 + ML/DL + 前沿，每阶段都「做出能跑的东西」，用项目与笔记积累作品集。"
        },
